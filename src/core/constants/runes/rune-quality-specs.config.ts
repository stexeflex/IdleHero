...
export const RUNE_CHANCE: RuneQualitySpec[] = [
  ...
  { Quality: 'Magic', Value: { Min: 0.1, Max: 0.2, Type: 'Percent' } },
  { Quality: 'Rare', Value: { Min: 0.2, Max: 0.4, Type: 'Percent' } },
  { Quality: 'Epic', Value: { Min: 0.4, Max: 0.75, Type: 'Percent' } },
...
export const RUNE_BLEEDING_DAMAGE: RuneQualitySpec[] = [
  ...
  { Quality: 'Epic', Value: { Min: 0.35, Max: 0.6, Type: 'Percent' } },
  { Quality: 'Legendary', Value: { Min: 0.6, Max: 1.25, Type: 'Percent' } }
];
...
export const RUNE_CRIT_DAMAGE: RuneQualitySpec[] = [
  ...
  { Quality: 'Legendary', Value: { Min: 1.0, Max: 2.0, Type: 'Percent' } }
];
...
export const RUNE_MULTI_HIT_DAMAGE: RuneQualitySpec[] = [
  ...
  { Quality: 'Legendary', Value: { Min: 0.75, Max: 1.5, Type: 'Percent' } }
];
